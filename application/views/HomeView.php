								...
								<div class="content">
									<div class="tab-content">
										<div class="text-center">
											<img src="<?php echo base_url('assets/img/'.$dogpet->foto);?>" class="img-rounded" width="100px" height="100px">
										</div>
										<div class="text-center">
										</br>
										<h4> <?php echo $dogpet->judul?> </h4>
									</div>
									<div class="text-center">
										<p> <?php echo $dogpet->harga?> </p>
									</div>
								</div>
								<div class="text-center">
									<button type="button" class="btn btn-primary btn-round" onclick="CekLogin()">Buy</button>
								</div>
							</div>
						</div>
					</br>
			...
			<div class="col-md-3">
				<div class="card">
					<div class="content">
						<div class="tab-content">
							<div class="text-center">
								<img src="<?php echo base_url('assets/img/'.$catpet->foto);?>" class="img-rounded" width="100px" height="100px">
							</div>
							<div class="text-center">
							</br>
							<h4> <?php echo $catpet->judul?> </h4>
						</div>
						<div class="text-center">
							<p> <?php echo $catpet->harga?> </p>
						</div>
					</div>
					<div class="text-center">
						<button type="button" class="btn btn-primary btn-round" onclick="CekLogin()">Buy</button>
...
<div class="card card-nav-tabs">
	...
	<div class="content">
		<div class="tab-content">
			...
			<?php
			$start = 0;
			foreach ($HomeSmallPet as $smallpet)
			{
				?>
				<div class="col-md-3">
					<div class="card">
						<div class="content">
							<div class="tab-content">
								<div class="text-center">
									<img src="<?php echo base_url('assets/img/'.$smallpet->foto);?>" class="img-rounded" width="100px" height="100px">
								</div>
								<div class="text-center">
								</br>
								<h4> <?php echo $smallpet->judul?> </h4>
							</div>
							<div class="text-center">
								<p> <?php echo $smallpet->harga?> </p>
							</div>
						</div>
						<div class="text-center">
							<button type="button" class="btn btn-primary btn-round" onclick="CekLogin()">Buy</button>
...
<div class="card card-nav-tabs">
	...
	<div class="content">
		<div class="tab-content">
			...
			<?php
			$start = 0;
			foreach ($HomePetAccessories as $petaccessories)
			{
				?>
				<div class="col-md-3">
					<div class="card">
						<div class="content">
							<div class="tab-content">
								<div class="text-center">
									<img src="<?php echo base_url('assets/img/'.$petaccessories->foto);?>" class="img-rounded" width="100px" height="100px">
								</div>
								<div class="text-center">
								</br>
								<h4> <?php echo $petaccessories->judul?> </h4>
							</div>
							<div class="text-center">
								<p> <?php echo $petaccessories->harga?> </p>
							</div>
						</div>
						<div class="text-center">
							<button type="button" class="btn btn-primary btn-round" onclick="CekLogin()">Buy</button>
		...
		<div class="card card-signup">
			<form id="formLogin" class="form" action="<?php echo site_url('login'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="content">
					...
					<div class="alert alert-danger" id="alertmodal_danger1">
						<div class="container-fluid">
							<div class="alert-icon">
								<i class="material-icons">error_outline</i>
							</div>
...
<!-- alert login -->
<div class="modal fade" id="ModalAlertLogin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
		</br>
		...
		<button type="button" class="btn btn-danger btn-round" onclick="ShowModal()" data-dismiss="modal" aria-label="Close">OK</button>
	</div>
</form>
</div>
